...
function vidahtml(vida){
  ...
  var html = ""
	...
	html +="<tr><td>Sorte:</td>"
	html +="<td>18</td>"
	html +="<td><button onClick='roll18()'>ROLL</button></td></tr>"
	...
	html +="<td>9</td>"
	html +="<td><button onClick='roll9()'>ROLL</button></td></tr>"
...
html9 += "<tr><td>Nome</td><td>Estella Leger Watson</td></tr>"

html9 += "<tr><td>Jogador</td><td>Bia</td></tr>"

html9 += "<tr><td>Ocupação</td><td>Assasina</td></tr>"

html9 += "<tr><td>Idade</td><td>23</td></tr>"
